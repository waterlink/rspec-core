Feature: Randomization can be reproduced across test runs
  ...
  If you would like to manage seeding randomization without any help from
  RSpec, please keep the following things in mind:
    ...
    * Report the seed that was chosen.
      ...
      The randomization that was used for a given test run can not be
      reproduced if no one knows what seed was used to begin with.
